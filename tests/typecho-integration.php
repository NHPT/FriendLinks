...
$check(
    false === strpos($notificationsPanel, '测试已保存配置')
        ...
        && false !== strpos($notificationsPanel, 'flm-form-actions flm-notification-actions')
        && false !== strpos($notificationsPanel, 'data-flm-notification-queue')
        && false === strpos($adminStyles, '.flm-notification-panel > .btn')
        ...
        && false !== strpos($adminStyles, '.flm-admin .flm-notification-actions')
        && false !== strpos($adminScript, 'initializeNotificationTestButtons')
        && false !== strpos($adminScript, "button.hidden = id !== 'policy'")
        && false !== strpos($adminScript, 'button.hidden =')
